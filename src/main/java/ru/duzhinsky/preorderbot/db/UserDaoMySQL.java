...
public class UserDaoMySQL implements UserDao {
    ...
    private static final String getUserByPhoneQuery = "SELECT users.id, users.phone FROM users WHERE users.phone=? LIMIT 1;";
    ...
    private static final String associateUserWithTelegramQuery = "INSERT INTO tgusers (user_id, tgusername) SELECT id, ? FROM users WHERE phone=? LIMIT 1;";
    ...
    @Override
    public void associateUserWithTelegram(String phone, String username) {
        try {
